...
async function seed() {
  ...
  await guestRepo.save([
    { hotelId, reservationId: res1.id, docType: 'CC', docNum: '12345678', nombre: 'Juan',  apellido: 'Pérez',   fechaNac: '1990-03-15', ciudadResidencia: 'Bogotá',    ciudadOrigen: 'Bogotá',    tel1: '3001234567', vacuna: 'si', esTitular: true  },
    { hotelId, reservationId: res1.id, docType: 'CC', docNum: '98765432', nombre: 'Laura', apellido: 'Pérez',   fechaNac: '1993-07-22', ciudadResidencia: 'Bogotá',    ciudadOrigen: 'Bogotá',    tel1: '3009876543', vacuna: 'si', esTitular: false },
  ]);
  ...
  const g2 = await guestRepo.save(
    { hotelId, reservationId: res2.id, docType: 'CC', docNum: '23456789', nombre: 'María', apellido: 'García', fechaNac: '1985-11-05', ciudadResidencia: 'Medellín', ciudadOrigen: 'Medellín', tel1: '3112345678', vacuna: 'si', esTitular: true },
  );
  ...
  const g3a = await guestRepo.save(
    { hotelId, reservationId: res3.id, docType: 'CC', docNum: '34567890', nombre: 'Carlos', apellido: 'Rodríguez', fechaNac: '1978-06-20', ciudadResidencia: 'Cali', ciudadOrigen: 'Cali', tel1: '3201234567', vacuna: 'si', esTitular: true  },
  );
  ...
  const g4 = await guestRepo.save(
    { hotelId, reservationId: res4.id, docType: 'CE', docNum: '45678901', nombre: 'Ana', apellido: 'López', fechaNac: '1995-09-30', ciudadResidencia: 'Bucaramanga', ciudadOrigen: 'Bucaramanga', tel1: '3151234567', vacuna: 'si', esTitular: true },
  );
  ...
  const g5a = await guestRepo.save(
    { hotelId, reservationId: res5.id, docType: 'CC', docNum: '56789012', nombre: 'Pedro',   apellido: 'Martínez', fechaNac: '1982-04-18', ciudadResidencia: 'Barranquilla', ciudadOrigen: 'Barranquilla', tel1: '3251234567', vacuna: 'si', esTitular: true  },
  );
